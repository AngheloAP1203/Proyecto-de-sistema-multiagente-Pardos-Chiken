...
const datos = {
  reservations: [
    { id:'R001', tableId:'T03', clientName:'María García', clientDni:'78765432', date:hoy, status:'seated' },
    { id:'R002', tableId:'T01', clientName:'Roberto Silva', clientDni:'91234567', date:hoy, status:'completed' },
  ],
...
let r = await rewardAgent.evaluar(
  { tableId:'T03', dni:'78765432', cliente:'María García', puntos_criticos:['Pollo frío'], prioridad:'Alta', mensaje:'el pollo llegó frío' },
  datos)
...
r = await rewardAgent.evaluar(
  { tableId:'T03', dni:'99900011', cliente:'Vivo', puntos_criticos:['Pollo frío'], prioridad:'Alta' },
  datos)
...
r = await rewardAgent.evaluar({ tableId:'T09', dni:'78765432', prioridad:'Alta' }, datos)
...
r = await rewardAgent.evaluar(
  { tableId:'T03', dni:'78765432', puntos_criticos:['algo raro'], prioridad:'Crítica' }, datos)
